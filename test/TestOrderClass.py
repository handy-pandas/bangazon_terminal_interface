...
class TestOrder(unittest.TestCase):
    ...
    def test_if_order_exists_in_database(self):    
        ...
        customer_order = self.order.retrieve_order_by_attributes(self.control.active_customer, payment_type_id)

        self.assertEqual(customer_order['customer_id'], self.control.active_customer)
    ...
    def test_complete_order(self):
        ...
        payment_types = self.payment_type.get_active_users_payment_types(self.control.active_customer)
        payment_type_id = 1
        self.assertIsNotNone(payment_types)
        self.control.update_payment_type_for_order(active_order, payment_type_id)
